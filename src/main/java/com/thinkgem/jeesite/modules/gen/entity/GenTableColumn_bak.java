 ...
 * @version 2013-10-15
 */
public class GenTableColumn_bak extends DataEntity<GenTableColumn_bak> {
	...
	public GenTableColumn_bak() {
		super();
	}

	public GenTableColumn_bak(String id){
		super(id);
	}

	public GenTableColumn_bak(GenTable genTable){
