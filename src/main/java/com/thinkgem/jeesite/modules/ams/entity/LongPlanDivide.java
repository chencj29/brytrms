 ...
 * @version 2016-01-11
 */
public class LongPlanDivide extends DataEntity<LongPlanDivide> {
	...
	private String departurePlanTimeStr;  // 计划起飞时间 只有小时:分钟，要根据航班计划初始化时具体选择的日期来组合
	private String arrivalPlanTimeStr;    // 计划到达时间 只有小时:分钟，要根据航班计划初始化时选择的日期来组合
	...
	private Date applyDate; // 计划应用日期
	
	public LongPlanDivide() {
		super();
	}

	public LongPlanDivide(String id){
		super(id);
	}
	...
	public String getDeparturePlanTimeStr() {
		return departurePlanTimeStr;
	}

	public void setDeparturePlanTimeStr(String departurePlanTimeStr) {
		this.departurePlanTimeStr = departurePlanTimeStr;
	}

	public String getArrivalPlanTimeStr() {
		return arrivalPlanTimeStr;
	}

	public void setArrivalPlanTimeStr(String arrivalPlanTimeStr) {
		this.arrivalPlanTimeStr = arrivalPlanTimeStr;
	}
