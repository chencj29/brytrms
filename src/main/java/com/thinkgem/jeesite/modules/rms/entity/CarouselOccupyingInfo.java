 ...
 */
@Oci
@Monitor(desc = "行李转盘占用信息", tableName = "rms_carousel_oci", service = CarouselOccupyingInfoService.class, socketNS = "/global/dynamics")
public class CarouselOccupyingInfo extends DataEntity<CarouselOccupyingInfo> {
    ...
    public CarouselOccupyingInfo() {
        super();
    }

    public CarouselOccupyingInfo(String id) {
        super(id);
    }
    ...
    public String toString() {
        ...
        if (expectedCarouselNum != null) msg.append("预计占用行李转盘个数:").append(expectedCarouselNum).append(",");
        if (actualCarouselNum != null) msg.append("实际占用行李转盘个数:").append(actualCarouselNum).append(",");
        if (inteCarouselCode != null) msg.append("行李转盘编号(国内):").append(inteCarouselCode).append(",");
        if (intlCarouselCode != null) msg.append("行李转盘编号(国际):").append(intlCarouselCode).append(",");
