...
@Monitor(desc = "值机柜台基础信息表信息", tableName = "rms_checkin_counter", service = CheckinCounterService.class, socketNS = "/rms/checkinCounter")
public class CheckinCounter extends DataEntity<CheckinCounter> {
    ...
    public CheckinCounter(String id) {
        super(id);
    }
