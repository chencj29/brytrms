...
public class CarouselOccupyingInfoWrapper extends FlightDynamic {
    ...
    private String detailId; // 模拟分配详情ID

    public CarouselOccupyingInfoWrapper() {
        super();
    }

    public CarouselOccupyingInfoWrapper(String id) {
        super(id);
    }
