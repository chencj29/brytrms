...
@Monitor(desc = "航班出仓机单信息", tableName = "rms_dock_out_list", service = DockOutListService.class, socketNS = "/rms/dockOutList")
public class DockOutList extends DataEntity<DockOutList> {
    ...
    @Label("斗号")
    @MonitorField(desc = "斗号")
    private Long hopperNum;        // 斗号
    @Label("货物名称")
    @MonitorField(desc = "货物名称")
    private String cargoName;        // 货物名称
    @Label("件数")
    @MonitorField(desc = "件数")
    private String cargoNum;        // 件数
    @Label("重量")
    ...
    public Long getHopperNum() {
        return hopperNum;
    }

    public void setHopperNum(Long hopperNum) {
    ...
    @Length(min = 0, max = 20, message = "件数长度必须介于 0 和 20 之间")
