...
//		model.addAttribute("officeList", officeService.findListLevel(office));
		// 航空公司
		FlightCompanyInfo flightCompanyInfo = new FlightCompanyInfo();
		//借ChineseShort字段传递是否按中文拼音排序
		flightCompanyInfo.setChineseShort("trueSort");
		model.addAttribute("companyList", flightCompanyInfoService.findList(flightCompanyInfo));
		// 服务提供者serviceList
		model.addAttribute("serviceList", serviceProviderService.findList(new ServiceProvider()));
