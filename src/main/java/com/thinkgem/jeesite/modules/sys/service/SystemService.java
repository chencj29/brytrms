...
//		systemRealm.clearAllCachedAuthorizationInfo();
    ...
    public void saveRole(Role role) {
        ...
        // 更新角色与航空公司关联
        roleDao.deleteRoleCompany(role);
        if (role.getCompanyList().size() > 0) {
            roleDao.insertRoleCompany(role);
        }

        // 更新服务提供者 代理人
        roleDao.deleteRoleService(role);
        if (role.getServiceIdList().size() > 0) {
            roleDao.insertRoleService(role);
        }
        // 同步到Activiti
        saveActivitiGroup(role);
        // 清除用户角色缓存
...
//		// 清除权限缓存
    ...
    public static boolean printKeyLoadMessage() {
        ...
        sb.append("\r\n======================================================================\r\n");
        sb.append("\r\n    欢迎使用 " + Global.getConfig("productName") + "  - Powered By http://www.metadata.net.cn\r\n");
        sb.append("\r\n======================================================================\r\n");
