...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
    ...
    private static Map<Integer, String> weekOfDayMap = new HashMap<Integer, String>();

    static {
        weekOfDayMap.put(1, "一");
        weekOfDayMap.put(2, "二");
        weekOfDayMap.put(3, "三");
        weekOfDayMap.put(4, "四");
        weekOfDayMap.put(5, "五");
        weekOfDayMap.put(6, "六");
        weekOfDayMap.put(0, "日");
    }
     ...
     * @return
     */
    public static long pastMinutes(Date oldDate,Date newDate) {
     ...
     * @return String
     * @throws
     * @Title: getWeekChinese
     * @Description: 根据日期获取
     * @author: chencheng
     * @date： 2016年1月14日 下午3:35:20
     */
    public static String getWeekChinese(Date date) {
        int week = getDayOfWeekByDate(date);
        String weekChinese = weekOfDayMap.get(week - 1);
        return weekChinese;
    }
    ...
    public static void main(String[] args) throws ParseException {
        ...
        String dateStr = "2016-1-14";
        Date date = DateUtils.parseDate(dateStr, "yyyy-MM-dd");
        int week = DateUtils.getDayOfWeekByDate(date);
     ...
     * @return
     */
    public static Boolean diffDate(Date oldDate,Date newDate){
