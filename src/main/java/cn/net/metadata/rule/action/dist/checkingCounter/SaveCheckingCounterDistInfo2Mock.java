 ...
 */
@Component
public class SaveCheckingCounterDistInfo2Mock implements FlowAction {
    @Autowired
    ...
    public void execute(ActionNode actionNode, FlowContext flowContext, ProcessInstance processInstance) {
        ...
        if (null != flightDynamic && checkingCounterOccupyingInfo != null) {
            ...
            detail.setInte(checkingCounterOccupyingInfo.getInteCheckingCounterCode());
            detail.setIntl(checkingCounterOccupyingInfo.getIntlCheckingCounterCode());
