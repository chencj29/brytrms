...
$(function () {
    ...
    $('li.drag-item > input:checkbox').on('click', function () {
...
function initDrop () {
    $('.drag-item').edraggable({ revert: true, deltaX: 0, deltaY: 0, axis: 'v',scroll: true, scrollSpeed: 100 }).edroppable(droppableProperties).click(function () {
