...
function initDrop () {
    $('.drag-item').edraggable({ revert: true, deltaX: 0, deltaY: 0, axis: 'v',scroll: true, scrollSpeed: 100 }).edroppable(droppableProperties).click(function (event) {
        ...
        result.visible = $("input:checkbox",this).prop('checked');
...
var draggableProperties = {distance: 20,revert: true, deltaX: 0, deltaY: 0, axis: 'v' },
    droppableProperties = {
