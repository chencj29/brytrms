...
$(function () {
    ...
    //显示颜色
    toolbarDate.push({text: '颜色设置', iconCls: 'icon-color', handler: colorSettingHandler})
    ...
    //全屏显示
    toolbarDate.push({
        text: '全屏显示', iconCls: 'icon-arrow_out', handler: function () {
            if($(".layui-layer-title",window.parent.document).html()) return;
            var port_layer = parent.layer.open({
                title: "安检航班信息",
                type: 2,
                area: ['1000px', '500px'],
    ...
    datagrid = $("#datagrid").datagrid({
        ...
        toolbar: toolbarDate, rowStyler: commonRowStyler,
