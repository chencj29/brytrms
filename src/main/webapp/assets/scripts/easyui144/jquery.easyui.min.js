...
var _42=$(this);
if(_42.edroppable("options").disabled){
return;
}
var p2=_42.offset();
...
var _4c=$(this);
if(_4c.edroppable("options").disabled){
return;
}
var p2=_4c.offset();
...
function _44(){
if($.fn.edraggable.timer){
clearTimeout($.fn.edraggable.timer);
$.fn.edraggable.timer=undefined;
}
...
$.fn.edraggable=function(_4d,_4e){
if(typeof _4d=="string"){
return $.fn.edraggable.methods[_4d](this,_4e);
}
return this.each(function(){
var _4f;
var _50=$.data(this,"draggable");
if(_50){
_50.handle.unbind(".edraggable");
_4f=$.extend(_50.options,_4d);
}else{
_4f=$.extend({},$.fn.edraggable.defaults,$.fn.edraggable.parseOptions(this),_4d||{});
}
...
_51.unbind(".edraggable").bind("mousemove.edraggable",{target:this},function(e){
if($.fn.edraggable.isDragging){
return;
}
...
$(document).bind("mousedown.edraggable",e.data,_39);
$(document).bind("mousemove.edraggable",e.data,_3f);
$(document).bind("mouseup.edraggable",e.data,_43);
$.fn.edraggable.timer=setTimeout(function(){
...
$.fn.edraggable.parseOptions=function(_5d){
var t=$(_5d);
...
$.fn.edraggable.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,delay:100,onBeforeDrag:function(e){
...
$.fn.edroppable=function(_64,_65){
if(typeof _64=="string"){
return $.fn.edroppable.methods[_64](this,_65);
}
_64=_64||{};
return this.each(function(){
...
_5e(this);
$.data(this,"droppable",{options:$.extend({},$.fn.edroppable.defaults,$.fn.edroppable.parseOptions(this),_64)});
}
});
};
$.fn.edroppable.methods={options:function(jq){
return $.data(jq[0],"droppable").options;
},enable:function(jq){
return jq.each(function(){
$(this).edroppable({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).edroppable({disabled:true});
});
}};
$.fn.edroppable.parseOptions=function(_67){
var t=$(_67);
return $.extend({},$.parser.parseOptions(_67,["accept"]),{disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.edroppable.defaults={accept:null,disabled:false,onDragEnter:function(e,_68){
...
_e7.disabledNodes=[];
_e8.dnd=true;
_e9.find("div.tree-node").edraggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_ea){
...
$(_e7.disabledNodes[i]).edroppable("enable");
}
_e7.disabledNodes=[];
...
}}).edroppable({accept:"div.tree-node",onDragEnter:function(e,_ee){
...
if($(this).edroppable("options").disabled){
return;
}
var _f2=_f1.pageY;
...
var _fe=$(_fc).edraggable("proxy").find("span.tree-dnd-icon");
...
_286.window.edraggable({handle:">div.panel-header>div.panel-title",disabled:_286.options.edraggable==false,onStartDrag:function(e){
if(_286.mask){
...
if(col.formatter){
cc.push(col.formatter(_7aa,_7a7,_7a6, _7a9));
}else{
cc.push(_7aa);
}
}
...
function _7ce(_7cf){
var _7d0=_7cf?1:2;
for(var i=parseInt(_7cc)+1;i<data.rows.length;i++){
...
_aa0.find("a.slider-handle").edraggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
