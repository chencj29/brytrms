...
<script>
    ...
    <shiro:hasPermission name="ams:flightCompanyInfo:edit">flagDgEdit=true;</shiro:hasPermission>
    <shiro:hasPermission name="ams:flightCompanyInfo:insert">flagDgInsert=true;</shiro:hasPermission>
    <shiro:hasPermission name="ams:flightCompanyInfo:del">flagDgDel=true;</shiro:hasPermission>
