...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center'">
        <table class="easyui-datagrid" title="安检口占用信息" id="datagrid" sortName="intlSecurityCheckinCode" sortOrder="asc">
            <thead>
            <tr>
			   	<th field="id" width="100" hidden="true" sortable="false" order="false">主键</th>
				<th field="intlSecurityCheckinCode" width="100" align="center" sortable="true">安检口编号(国际)</th>
	...
	<div data-options="region:'south'" style="height:180px;">
        <form action="${ctx}/rms/securityCheckinOccupyingInfo/save" id="modifyForm">
            <input type="hidden" name="id">
            <table width="100%" class="formtable">
                <tr>
                    <td>安检口编号(国际)：</td>
                    <td>
						<input type="text" name="intlSecurityCheckinCode" class="easyui-textbox easyui-validatebox"
							 data-options=""
						>
					</td>
                    <td>预计开始占用时间：</td>
                ...
                <tr>
                    ...
                    <td>
						<input name="createDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="<fmt:formatDate value="${securityCheckinOccupyingInfo.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
					</td>
                    <td>更新人：</td>
                    <td>
                    ...
                    <td>
						<input name="updateDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
							value="<fmt:formatDate value="${securityCheckinOccupyingInfo.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
							onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
					</td>
                    <td>备注：</td>
                    <td>
...
<script>
    var moduleContext = "securityCheckinOccupyingInfo";
    ...
    <shiro:hasPermission name="rms:securityCheckinOccupyingInfo:edit">flagDgEdit=true;</shiro:hasPermission>
    <shiro:hasPermission name="rms:securityCheckinOccupyingInfo:insert">flagDgInsert=true;</shiro:hasPermission>
    <shiro:hasPermission name="rms:securityCheckinOccupyingInfo:del">flagDgDel=true;</shiro:hasPermission>
