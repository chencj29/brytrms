...
<div class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'south'" style="height:180px;">
        <form action="${ctx}/rms/rmsFlightDuty/save" id="modifyForm">
            ...
            <div style="text-align: center; margin-top:15px; margin-right:15px;">
                <a class="easyui-linkbutton" id="btnEdit" data-options="iconCls:'icon-edit'" style="width:80px">编辑</a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a class="easyui-linkbutton" id="btnSave" data-options="iconCls:'icon-ok'" style="width:80px">保存</a>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <a class="easyui-linkbutton" id="btnLoadSave" data-options="iconCls:'icon-redo'"
...
<script>
    var moduleContext = "rmsFlightDuty";
    /**
     * 过滤列声明接口(必须，可空)
     */
    var specialFilteringColumnDefinition = [];
    <shiro:hasPermission name="rms:rmsFlightDuty:edit">flagDgEdit = true;
    </shiro:hasPermission>
    ...
    <shiro:hasPermission name="rms:rmsFlightDuty:expExcel">flagDgExp = true;
    </shiro:hasPermission>
    ...
    function getFlightDutys() {
        ...
        if (row) {
            $.ajax({
                type: "post",
                async: false,
                url: "${ctx}/rms/rmsFlightDuty/getFlightDutys",
...
<script>
    ...
    $(function () {
        ...
        $("#btnLoadSave").linkbutton('disable');
        //添加新增按钮；
        if (flagDgInsert) {
            toolbarDate.push({
        ...
        $("#btnLoadSave").click(function () {
            if ($(this).linkbutton('options').disabled == false && $('#modifyForm').form('validate')) {
                ...
                $.post(ctx + "/rms/" + moduleContext + "/loadSave", $("#modifyForm").serialize(), function (data) {
                    if (data.code === 1) datagrid.datagrid("reload");
                    $.messager.show({title: "提示", msg: data.message, timeout: 5000, showType: 'slide'});
                });
            }
