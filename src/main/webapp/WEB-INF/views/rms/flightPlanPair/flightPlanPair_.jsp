...
<script type="text/html" id="datagridTpl">
    <table id="datagrid" title="航班配对信息" group="true" adjust="true">
        <thead>
        <tr>
            ...
            <th field="planDate" width="66" align="center" formatter="formatDate" rowspan="2">计划日期</th>
            ...
            <th field="in" colspan="19" align="center">进港</th>
            <th field="out" colspan="16" align="center">出港</th>
        </tr>
        <tr>
            <th field="agentCode" width="30" align="center" parent="proxy">ID</th>
            <th field="agentName" width="70" align="center" parent="proxy">名称</th>
            ...
            <th field="safecuardTypeName" width="70" align="center" parent="safeguard">名称</th>
            ...
            <th field="statusName" width="60" align="center" parent="in">航班状态</th>
            ...
            <th field="departurePlanTime" width="70" align="center" formatter="dateFmt" parent="in">计飞</th>
            <th field="arrivalPlanTime" width="70" align="center" formatter="dateFmt" parent="in">计达</th>
            <th field="eta" width="70" align="center" formatter="dateFmt" parent="in">预达</th>
            <th field="atd" width="70" align="center" formatter="dateFmt" parent="in">实飞</th>
            <th field="ata" width="70" align="center" formatter="dateFmt" parent="in">实达</th>
            <th field="vip" width="70" align="center" formatter="vipFmt" styler="css" parent="in">VIP</th>
            <th field="delayResonsName" width="120" align="center" parent="in">延误原因</th>
            <th field="delayResonsRemark" width="70" align="center" parent="in">备注</th>
            <th field="alternateAreaName" width="120" align="center" parent="in">备降</th>
            ...
            <th field="statusName2" width="60" align="center" parent="out">航班状态</th>
            ...
            <th field="VIP2" width="70" align="center" formatter="vipFmt" styler="css" parent="out">VIP</th>
            <th field="departurePlanTime2" width="70" align="center" formatter="dateFmt" parent="out">计飞</th>
            <th field="etd2" width="70" align="center" formatter="dateFmt" parent="out">预飞</th>
            <th field="atd2" width="70" align="center" formatter="dateFmt" parent="out">实飞</th>
            <th field="delayResonsName2" width="120" align="center" parent="out">延误原因</th>
            <th field="delayResonsRemark2" width="120" align="center" parent="out">备注</th>
        </tr>
        </thead>
    </table>
</script>
