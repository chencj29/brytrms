...
<script>
    var moduleContext = "rmsFlightPreManifest";
    /**
     * 过滤列声明接口(必须，可空)
     */
    var specialFilteringColumnDefinition = [];
    <shiro:hasPermission name="rms:rmsFlightPreManifest:edit">flagDgEdit = true;
    </shiro:hasPermission>
    ...
    <shiro:hasPermission name="rms:rmsFlightPreManifest:expExcel">flagDgExp = true;
    </shiro:hasPermission>
    ...
    function getListAndFill (flightDynamicId) {
        ...
        if (row) {
            $.ajax({
                type: "post",
                async: false,
                url: "${ctx}/rms/" + moduleContext + "/getFlightPreManifests",
