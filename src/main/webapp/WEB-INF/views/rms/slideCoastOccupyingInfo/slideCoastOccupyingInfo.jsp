...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center'">
        <table class="easyui-datagrid" title="滑槽占用信息" id="datagrid" sortName="intlSlideCoastCode" sortOrder="asc">
            <thead>
            <tr>
			   	<th field="id" width="100" hidden="true" sortable="false" order="false">主键</th>
				<th field="intlSlideCoastCode" width="100" align="center" sortable="true">滑槽编号(国际)</th>
	...
	<div data-options="region:'south'" style="height:180px;">
        <form action="${ctx}/rms/slideCoastOccupyingInfo/save" id="modifyForm">
            <input type="hidden" name="id">
            <table width="100%" class="formtable">
                <tr>
                    <td>滑槽编号(国际)：</td>
                    <td>
						<input type="text" name="intlSlideCoastCode" class="easyui-textbox easyui-validatebox"
							 data-options=""
						>
					</td>
                    <td>预计开始占用时间：</td>
...
<script>
    var moduleContext = "slideCoastOccupyingInfo";
    /**
     * 过滤列声明接口(必须，可空)
     */
