    ...
    <div region="center" style="padding:1px;">
       <table width="100%" id="${statisticsName}List" toolbar="#${statisticsName}Listtb">
           ...
           <tr>
               ...
               <th field="flightNum" width="50" hidden="true" align="center" sortable="true">航班号</th>
               ...
               <th field="placeNum" width="80" align="center" sortable="true" hidden="true">机位</th>
               ...
               <th field="inteActualStartTime" formatter="dateFmt" width="100" align="center" sortable="true">实际开始时间</th>
               <th field="inteActualOverTime" width="100" align="center" sortable="true">实际结束时间</th>
               <th field="intlCarouselCode" width="100" align="center" sortable="true">国际航段</th>
               <th field="intlActualStartTime" width="100" align="center" sortable="true">实际开始时间</th>
               <th field="intlActualOverTime" width="100" align="center" sortable="true">实际结束时间</th>
               ...
               <th field="expectedStartTime" formatter="dateFmt" width="100" align="center" sortable="true">预计开始时间</th>
               <th field="expectedOverTime" formatter="dateFmt" width="100" align="center" sortable="true">预计结束时间</th>
            ...
            <div name="searchColums" style="display:inline">
                <input id="_sqlbuilder" name="sqlbuilder" type="hidden" />
                     <span style="display:-moz-inline-box;display:inline-block;">
                        ...
                        <span style="text-align:right;" title="行李转盘编号">行李转盘编号：</span>
                        <input class="inuptxt" type="text" name="inteCarouselCode" onkeypress="EnterPress(event)" onkeydown="EnterPress()">
                     </span>
            </div>
...
<script>
    ...
    function generateXAxis() {
        return [moment().add(-1, "days").format("YYYY-MM-DD"), moment().format("YYYY-MM-DD"), moment().add(1, "days").format("YYYY-MM-DD")];
        //return ['2016-03-19', '2016-03-20', '2016-03-21'];
    }
