...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center'">
        <table class="easyui-datagrid" title="到港门占用信息" id="datagrid" sortName="intlArrivalGateCode" sortOrder="asc">
            <thead>
            <tr>
			   	<th field="id" width="100" hidden="true" sortable="false" order="false">主键</th>
				<th field="intlArrivalGateCode" width="100" align="center" sortable="true">到港门编号(国际)</th>
	...
	<div data-options="region:'south'" style="height:180px;">
        <form action="${ctx}/rms/arrivalGateOccupyingInfo/save" id="modifyForm">
            <input type="hidden" name="id">
            <table width="100%" class="formtable">
                <tr>
                    <td>到港门编号(国际)：</td>
                    <td>
						<input type="text" name="intlArrivalGateCode" class="easyui-textbox easyui-validatebox"
							 data-options=""
						>
					</td>
                    <td>预计开始占用时间：</td>
...
<script>
    var moduleContext = "arrivalGateOccupyingInfo";
    /**
     * 过滤列声明接口(必须，可空)
     */
