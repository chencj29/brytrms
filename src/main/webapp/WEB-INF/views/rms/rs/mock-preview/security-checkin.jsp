    ...
    <div data-options="region:'center'" id="dgContainer">
        <table id="dataGrid4Preview" class="easyui-datagrid">
            ...
            <tr>
                ...
                <th field="inteSecurityCheckinCode" width="100" align="center">国内航段</th>
                <th field="intlSecurityCheckinCode" width="100" align="center">国际航段</th>
...
<script src="${ctxAssets}/scripts/metadata-dev/resource-dist/mock-preview/security_checkin_dist.js"></script>
</body>