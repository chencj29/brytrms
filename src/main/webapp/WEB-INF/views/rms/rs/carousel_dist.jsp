...
<script src="${ctxAssets}/scripts/metadata-dev/resource-dist/carousel_dist.js"></script>
<script>
    <shiro:hasPermission name="rms:carousel_dist:auto_allo">flagAutoAllocation = true, flagMockDist = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:carousel_dist:manu_allo">flagManualAllocation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:carousel_dist:gant">flagFlightGant = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:carousel_dist:settime_oci">flagEndFlightOccupation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:carousel_dist:cancel_allo">flagCancelAllocation = true;
    </shiro:hasPermission>
</script>
<script type="text/html" id="datagridTpl">
    <table class="easyui-datagrid" id="datagrid" group="false" adjust="true" data-options="fitColumns:false,fit:true, remoteSort:false">
        <thead>
        <tr>
            <th field="id" width="100" hidden="true" order="false" sortable="true">主键</th>
            ...
            <th field="flightNatureCode" width="50" hidden="true" align="center" sortable="true">进港性质</th>
            <th field="flightDynamicId" width="100" hidden="true" order="false" sortable="true">航班动态编号</th>
            <th field="flightCompanyCode" width="50" hidden="true" align="center" order="false" sortable="true">航空公司</th>
            ...
            <th field="planDate" width="80" align="center" order="false" formatter="formatDate" sortable="true">计划日期</th>
            ...
            <th field="placeNum" width="60" align="center" sortable="true" sortable="true">机位</th>
            ...
            <th field="inoutTypeName" width="60" align="center" sortable="true">进出港</th>
            <th field="flightDynamicNature" width="80" formatter="natureFmt" align="center" sortable="true">属性</th>
            <th field="departureAirportCode" width="100" align="center" formatter="globalPlaceFmt" sortable="true">起飞</th>
            ...
            <th field="arrivalPlanTime" formatter="dateFmt" width="70" align="center" sortable="true">计达</th>
            <th field="etd" formatter="dateFmt" width="70" align="center" sortable="true">预飞</th>
            <th field="eta" formatter="dateFmt" width="70" align="center" sortable="true">预达</th>
            <th field="atd" formatter="dateFmt" width="70" align="center" sortable="true">实飞</th>
            <th field="ata" formatter="dateFmt" width="70" align="center" sortable="true">实达</th>
            <th field="inteCarouselCode" width="100" align="center" sortable="true">国内航段</th>
            <th field="intlCarouselCode" width="100" align="center" sortable="true">国际航段</th>
            ...
            <th field="cancelFlightResons" width="120" align="center" sortable="true">取消原因</th>
            <th field="alterNateAreaName" width="100" align="center" sortable="true">备降</th>
        </tr>
        </thead>
    </table>
</script>
