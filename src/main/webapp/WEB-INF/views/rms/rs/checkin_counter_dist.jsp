...
<script src="${ctxAssets}/scripts/metadata-dev/resource-dist/checkin_counter_dist.js"></script>
<script>
    <shiro:hasPermission name="rms:checkin_counter_dist:auto_allo">flagAutoAllocation = true, flagMockDist = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:checkin_counter_dist:manu_allo">flagManualAllocation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:checkin_counter_dist:gant">flagFlightGant = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:checkin_counter_dist:settime_oci">flagEndFlightOccupation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:checkin_counter_dist:cancel_allo">flagCancelAllocation = true;
    </shiro:hasPermission>
</script>
<script type="text/html" id="datagridTpl">
    <table class="easyui-datagrid" id="datagrid" group="false" adjust="true" data-options="fitColumns:false, fit:true, remoteSort:false" style="width:100%">
        <thead>
        <tr>
            ...
            <th field="placeNum" width="60" align="center" hidden="true" sortable="true">机位</th>
            <th field="status" width="70" align="center" hidden="true" sortable="true">状态编码</th>
            <th field="flightDynamicId" width="100" align="center" hidden="true" sortable="true">航班动态编号</th>
            <th field="flightNatureCode" width="50" hidden="true" align="center" sortable="true">出港性质</th>
            <th field="flightCompanyCode" width="50" align="center" hidden="true" sortable="true">航空公司</th>
            <th field="expectedCheckingCounterNum" width="50" align="center" hidden="true" sortable="true">预计占用数量</th>
            ...
            <th field="vitrualFlightNumber" formatter="vitrualFlightNumberFmt" width="80" align="center" sortable="true">航班号</th>
