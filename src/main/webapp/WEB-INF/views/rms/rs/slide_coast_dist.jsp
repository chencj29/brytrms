...
<script src="${ctxAssets}/scripts/metadata-dev/resource-dist/slide_coast_dist.js"></script>
<script>
    <shiro:hasPermission name="rms:slide_coast_dist:auto_allo">flagAutoAllocation = true, flagMockDist = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:slide_coast_dist:manu_allo">flagManualAllocation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:slide_coast_dist:gant">flagFlightGant = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:slide_coast_dist:settime_oci">flagEndFlightOccupation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:slide_coast_dist:cancel_allo">flagCancelAllocation = true;
    </shiro:hasPermission>
</script>
<script type="text/html" id="datagridTpl">
    <table class="easyui-datagrid" id="datagrid" group="false" adjust="true" data-options="fitColumns:false,fit:true, remoteSort:false">
        ...
        <tr>
            ...
            <th hidden="true" field="expectedCarouselNum" width="100" align="center" sortable="true">预计占用数量</th>
            ...
            <th field="departurePlanTime" formatter="dateFmt" width="100" align="center" sortable="true">计飞</th>
            <th field="etd" formatter="dateFmt" width="100" align="center" sortable="true">预飞</th>
            <th field="atd" formatter="dateFmt" width="100" align="center" sortable="true">实飞</th>
