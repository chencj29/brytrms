...
<script src="${ctxAssets}/scripts/metadata-dev/resource-dist/arrival_gate_dist.js"></script>
<script>
    <shiro:hasPermission name="rms:arrival_gate_dist:auto_allo">flagAutoAllocation = true, flagMockDist = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:arrival_gate_dist:manu_allo">flagManualAllocation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:arrival_gate_dist:gant">flagFlightGant = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:arrival_gate_dist:gant">flagFlightGant = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:arrival_gate_dist:settime_oci">flagEndFlightOccupation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:arrival_gate_dist:cancel_allo">flagCancelAllocation = true;
    </shiro:hasPermission>
</script>
<script type="text/html" id="datagridTpl">
    <table class="easyui-datagrid" id="datagrid" group="false" adjust="true" data-options="fitColumns:false, fit:true, remoteSort:false">
        ...
        <tr>
            ...
            <%--显示机位只有：登机口分配表 位机分配表 运输调度表--%>
            <%--<th field="placeNum" width="60" align="center" sortable="true">机位号</th>--%>
