...
<script src="${ctxAssets}/scripts/metadata-dev/resource-dist/departure_hall_dist.js"></script>
<script>
    <shiro:hasPermission name="rms:departure_hall_dist:auto_allo">flagAutoAllocation = true, flagMockDist = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:departure_hall_dist:manu_allo">flagManualAllocation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:departure_hall_dist:gant">flagFlightGant = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:departure_hall_dist:settime_oci">flagEndFlightOccupation = true;
    </shiro:hasPermission>
    <shiro:hasPermission name="rms:departure_hall_dist:cancel_allo">flagCancelAllocation = true;
    </shiro:hasPermission>
</script>
<script type="text/html" id="datagridTpl">
    <table class="easyui-datagrid" id="datagrid" group="false" adjust="true" data-options="fitColumns:false, fit:true, remoteSort:false">
        ...
        <tr>
            ...
            <th field="expectedDepartureHallNum" hidden="true" width="50" align="center" sortable="true">预计占用数量</th>
            ...
            <th field="inteDepartureHallCode" width="150" align="center" sortable="true">国内航段</th>
            <th field="intlDepartureHallCode" width="150" align="center" sortable="true">国际航段</th>
