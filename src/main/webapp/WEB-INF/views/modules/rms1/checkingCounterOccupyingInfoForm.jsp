...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/rms1/checkingCounterOccupyingInfo/">值机柜台占用信息列表</a></li>
		<li class="active"><a href="${ctx}/rms1/checkingCounterOccupyingInfo/form?id=${checkingCounterOccupyingInfo.id}">值机柜台占用信息<shiro:hasPermission name="rms1:checkingCounterOccupyingInfo:edit">${not empty checkingCounterOccupyingInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="rms1:checkingCounterOccupyingInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="checkingCounterOccupyingInfo" action="${ctx}/rms1/checkingCounterOccupyingInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="rms1:checkingCounterOccupyingInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
