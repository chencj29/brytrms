...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ams/aircraftParameters/">机型参数管理列表</a></li>
		<li class="active"><a href="${ctx}/ams/aircraftParameters/form?id=${aircraftParameters.id}">机型参数管理<shiro:hasPermission name="ams:aircraftParameters:edit">${not empty aircraftParameters.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ams:aircraftParameters:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="aircraftParameters" action="${ctx}/ams/aircraftParameters/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="aircraft" htmlEscape="false" maxlength="200" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">主机型：</label>
			<div class="controls">
				<form:input path="aircraftMain" htmlEscape="false" maxlength="200" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">子机型：</label>
			<div class="controls">
				<form:input path="aircraftSub" htmlEscape="false" maxlength="200" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否备用梯：</label>
			<div class="controls">
				<form:input path="useLift" htmlEscape="false" maxlength="18" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">是否用桥：</label>
			<div class="controls">
				<form:input path="useBridge" htmlEscape="false" maxlength="18" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="isbigtype" htmlEscape="false" maxlength="18" class="input-xlarge  digits"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="ams:aircraftParameters:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
