...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ams/companyAircraftNum/">公司机号管理列表</a></li>
		<li class="active"><a href="${ctx}/ams/companyAircraftNum/form?id=${companyAircraftNum.id}">公司机号管理<shiro:hasPermission name="ams:companyAircraftNum:edit">${not empty companyAircraftNum.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="ams:companyAircraftNum:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="companyAircraftNum" action="${ctx}/ams/companyAircraftNum/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="ams:companyAircraftNum:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
