...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/rms/checkinCounter/">值机柜台基础信息表列表</a></li>
		<li class="active"><a href="${ctx}/rms/checkinCounter/form?id=${checkinCounter.id}">值机柜台基础信息表<shiro:hasPermission name="rms:checkinCounter:edit">${not empty checkinCounter.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="rms:checkinCounter:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="checkinCounter" action="${ctx}/rms/checkinCounter/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="createTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${checkinCounter.createTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="updateTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${checkinCounter.updateTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<shiro:hasPermission name="rms:checkinCounter:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
