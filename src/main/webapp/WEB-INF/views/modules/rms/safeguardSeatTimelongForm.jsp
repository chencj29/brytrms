...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/rms/safeguardSeatTimelong/">保障过程及座位时长列表</a></li>
		<li class="active"><a href="${ctx}/rms/safeguardSeatTimelong/form?id=${safeguardSeatTimelong.id}">保障过程及座位时长<shiro:hasPermission name="rms:safeguardSeatTimelong:edit">${not empty safeguardSeatTimelong.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="rms:safeguardSeatTimelong:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="safeguardSeatTimelong" action="${ctx}/rms/safeguardSeatTimelong/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="rms:safeguardSeatTimelong:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
